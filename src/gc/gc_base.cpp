...
namespace pyston {
    namespace gc {
        ...
        void GCBase::visitByGCKind(void *p, GCVisitor &visitor) {
...
//                hcls->gc_visit(&visitor);
        ...
        void GCBase::graphTraversalMarking(gc::TraceStack &stack, GCVisitor &visitor) {
...
//            }
        ...
        void *GCBase::gc_alloc(size_t bytes, gc::GCKind kind_id) {
...
// if (VERBOSITY()) printf("Allocated %ld bytes at [%p, %p)\n", bytes, r, (char*)r + bytes);
    ...
    gc_alloc_bytes_typed[(int)kind_id].log(bytes);
        ...
        void *GCBase::gc_realloc(void *ptr, size_t bytes) {
    ...
    VALGRIND_FREELIKE_BLOCK(ptr, REDZONE_SIZE);
        ...
        void GCBase::prepareWeakrefCallbacks(Box *box) {
        ...
        void GCBase::finalizationOrderingFindReachable(Box *obj) {
        ...
        void GCBase::finalizationOrderingRemoveTemporaries(Box *obj) {
